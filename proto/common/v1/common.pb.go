...
// nauthilus.common.v1 is the shared gRPC contract owned by Nauthilus
// (server/grpcapi/common/v1/common.proto). This file mirrors the upstream
// contract so pfxhttp can compile the AuthService client against the current
// wire schema. Only the go_package option is adapted to this module.
...
const file_proto_common_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x1cproto/common/v1/common.proto\x12\x13nauthilus.common.v1\";\n" +
	...
	"\x19OPERATION_RESULT_CONFLICT\x10\x06B(Z&PostfixToHTTP/proto/common/v1;commonv1b\x06proto3"
